...
namespace panda_position_controller_ns
{
  class JointPositionController : public controller_interface::Controller<hardware_interface::PositionJointInterface> 
  {
     bool init(hardware_interface::PositionJointInterface *hw, ros::NodeHandle &n) 
     {
         ...
         sub_command_ = n.subscribe<std_msgs::Float64MultiArray>(std::string("command"), 1, &JointPositionController::setCommandCallback, this);
  ...
  PLUGINLIB_EXPORT_CLASS(panda_position_controller_ns::JointPositionController, controller_interface::ControllerBase);
}
